        ...
        <form action="{{ route('roles.update', $role->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $role->name) }}" required {{ in_array($role->name, ['admin', 'manager', 'barber', 'receptionist']) ? 'readonly' : '' }}>
                    @error('name')
