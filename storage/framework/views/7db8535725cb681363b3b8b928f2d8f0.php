    ...
    <form action="<?php echo e(route('appointments.store')); ?>" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php $__errorArgs = ['client_id'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php $__errorArgs = ['barber_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="barber_id" name="barber_id" required>
                    ...
                    <?php $__currentLoopData = $barbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($barber->id); ?>" <?php echo e(old('barber_id') == $barber->id ? 'selected' : ''); ?>>
                            <?php echo e($barber->name); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['barber_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php $__errorArgs = ['service_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="service_id" name="service_id" required>
                    ...
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($service->id); ?>" <?php echo e(old('service_id') == $service->id ? 'selected' : ''); ?>>
                            <?php echo e($service->name); ?> - R$ <?php echo e(number_format($service->price, 2, ',', '.')); ?>
...
unset($__errorArgs, $__bag); ?>" id="time" name="time" value="<?php echo e(old('time')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                    <option value="scheduled" <?php echo e(old('status') == 'scheduled' ? 'selected' : ''); ?>>Agendado</option>
                    <option value="confirmed" <?php echo e(old('status') == 'confirmed' ? 'selected' : ''); ?>>Confirmado</option>
                    <option value="completed" <?php echo e(old('status') == 'completed' ? 'selected' : ''); ?>>Concluído</option>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card-footer">
            ...
            <a href="<?php echo e(route('appointments.index')); ?>" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Elbarber_V4.0\resources\views/appointments/create.blade.php ENDPATH**/ ?>