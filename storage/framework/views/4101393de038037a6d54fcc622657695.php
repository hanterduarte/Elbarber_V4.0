<?php $__env->startSection('title', 'PDV'); ?>
...
<div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                <strong>Preço:</strong> R$ <?php echo e(number_format($service->price, 2, ',', '.')); ?><br>
                                                <strong>Duração:</strong> <?php echo e($service->duration); ?> min
                                            </p>
                                            <button type="button" class="btn btn-primary btn-block add-item" 
                                                ...
                                                data-is-active="<?php echo e($service->is_active); ?>">
                                                Adicionar
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                ...
                                                <strong>Estoque:</strong> <?php echo e($product->stock); ?>
                                            ...
                                            <button type="button" class="btn btn-primary btn-block add-item" 
                                                ...
                                                data-is-active="<?php echo e($product->is_active); ?>">
                                                Adicionar
                                            </button>
                                        </div>
                                    </div>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <form id="posForm" action="<?php echo e(route('pdv.sale')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Elbarber_V4.0\resources\views/pos/index.blade.php ENDPATH**/ ?>