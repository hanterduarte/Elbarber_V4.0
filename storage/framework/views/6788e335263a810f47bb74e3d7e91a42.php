<?php $__env->startSection('title', 'Novo Barbeiro'); ?>
...
<div class="card">
    ...
    <form action="<?php echo e(route('barbers.store')); ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                        <div class="mt-2">
                            <img id="photo-preview" src="<?php echo e(asset('images/default-avatar.png')); ?>" class="img-fluid" style="max-height: 200px;">
                        </div>
                    </div>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>" id="commission_rate" name="commission_rate" value="<?php echo e(old('commission_rate', 0)); ?>" min="0" max="100" step="0.01">
...
unset($__errorArgs, $__bag); ?>" id="bio" name="bio" rows="3"><?php echo e(old('bio')); ?></textarea>
                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Elbarber_V4.0\resources\views/barbers/create.blade.php ENDPATH**/ ?>